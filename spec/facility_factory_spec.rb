...
RSpec.describe FacilityFactory do
  ...
  describe '#create_mo_facilities' do
    it 'can create mo facilities_directly' do
      ...
      expect(@facility_factory1.facilities[0].services).to eq([])
      expect(@facility_factory1.facilities[0].holidays_closed).to eq('Christmas Day (12/25/23), New Year\'s Day (1/1/24), Martin Luther King Jr. Day (1/15/24), President\'s Day (2/19/24), Memorial Day (5/27/24), Juneteenth (6/19/24), Independence Day (7/4/24), Labor Day (9/2/24), Veterans Day (11/11/24), Thanksgiving Day (11/28/24), Christmas Day (12/25/24)')
      expect(@facility_factory1.facilities[0].registered_vehicles).to eq([])
      expect(@facility_factory1.facilities[0].collected_fees).to eq(0)
